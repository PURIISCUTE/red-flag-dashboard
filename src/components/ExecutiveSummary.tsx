        ...
        <div>
          <div className="flex flex-wrap items-center justify-between gap-2 mb-3 pb-3 border-b border-slate-800">
            ...
            <div className="flex items-center gap-2 text-xs">
              ...
              <span className="px-2 py-0.5 bg-emerald-500/10 text-emerald-400 rounded text-[11px] font-medium">
                SEC Ground Truth Verified
              </span>
            </div>
          </div>
